...
class MDM(nn.Module):
    def __init__(self, modeltype, njoints, nfeats,
        ...
        print("source_audio_dim", source_audio_dim, self.source_audio_dim)
...
if __name__ == '__main__':
    ...
    model = MDM(modeltype='', njoints=njoints, nfeats=1, cond_mode='cross_local_attention5_style1', audio_feat='wavlm',
                ...
                style_dim=style_dim, source_audio_dim=audio_feature_dim, audio_feat_dim_latent=64).to(device)
